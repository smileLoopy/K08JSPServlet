...
<body>
	<!--  
	import 태그
		: include 액션태그와 같은 기능으로 request영역을 공유한다. (즉, 실행된 결과만 삽입함)
		서로 다른 페이지이므로 page영역은 공유되지 않는다. => (Host:8080/프로젝트명/) 이렇게 안쓰고 바로 폴더명부터 사용함. 자동으로 인식하기 때문 
	...
	var속성을
		미사용시: 해당 위치에 즉시 포함된다.
		사용시: var에 지정한 변수로 EL로 출력하는곳에 포함된다.
