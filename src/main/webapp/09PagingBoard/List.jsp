...
List.jsp?pageNum => 이와 같이 파라미터는 있는데 값이 없을때는 빈값으로 체크된다.
...
//만약 검색어가 있다면 해당 조건에 맞는 게시물만 select해야 한다.
...
<body>
    ...
    <!-- 검색폼 -->
    <!-- form태그에 action 속성이 없으면 폼값은 현재 페이지로 전송된다. -->
    <form method="get">  
    ...
    <tr>
        <td align="center" style="height:55px">
            ...
            <input type="submit" value="검색하기"  class="btn btn-outline-secondary btn-sm "  />
        </td>
    </tr>   
    </table>
    </form>
...
%>
    ...
    <table border="1" width="90%">
        <tr align="center">
        		...
        		<!-- 글쓰기 버튼 -->
            <td><button type="button" onclick="location.href='Write.jsp';" class="btn btn-success" style="margin-right:10px">글쓰기
                </button></td>
        </tr>
