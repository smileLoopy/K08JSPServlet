...
정수끼리의 연산에서 실수의결과가 나올 수도 있다. -->
num3 / num4 : ${num3 / num4 } <br />
num3 div num4 : ${num3 div num4 } <br />
<!-- 나머지 연산을 위해 %와 mode연산자를 사용할 수 있다. -->
num3 % num4 : ${num3 % num4 } <br />
num3 mod num4 : ${num3 mod num4 } <br />

<!-- EL에서는 +는 뎃셈연산만 가능하고, 문자열의 연결에는 사용되지 않는다. -->
<h3>+ 연산자는 덧셈만 가능</h3>
...
<h3>논리 연산자</h3>
num 3 <= num4 && num 3 == num4 : ${num3 le num4 and num3 eq num4 } <br />
num 3 >= num4 || num 3 != num4 : ${num3 ge num4 or num3 ne num4 } <br />
