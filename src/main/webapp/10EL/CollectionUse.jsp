...
<h2>List 컬렉션</h2>
<%
//List컬렉션은 Object 기반으로 생성한다.
List <Object> aList = new ArrayList<Object>();
//아래와 같이 선언해도 Object 기반의 컬렉션이 된다. 하지만 권장되는 방법은 아님. 
...
<ul>
	<!-- String객체가 출력된다. ArrayList는 배열의 특성이 있으므로 인덱스로 접근할 수 있다. -->
...
%>
<ul>
	<!-- key값이 영문인 경우 아래 3가지 방법 모두 사용할 수 있으나, 한글인 경우
	.(점)으로 출력할 수 없다. -->
	<li>영문 Key: ${King["Eng"]}, ${King['Eng']}, ${King.Eng } </li>
	<li>한글 Key: ${King["한글"]}, ${King['한글']}, \${King.한글 } </li> <!-- 에러발생됨 -->
